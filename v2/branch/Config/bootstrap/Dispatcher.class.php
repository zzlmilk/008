...
class Dispatcher {
    ...
    private function DataProcess($pathArray) {
         ...
         * 最后一个  为 该模块运行的方法  
         */
        defined('MODULE_NAME_CONTROLLER') or define('MODULE_NAME_CONTROLLER', ucfirst($pathArray[count($pathArray) - 2]) . 'Controller');
        ...
        defined('MODULE_NAME') or define('MODULE_NAME', ucfirst($pathArray[count($pathArray) - 2]));
        /**
         * 载入该目录的Controller
         */
