            ...
            <table width="150" border="0" cellpadding="0" cellspacing="0" class="left-table01">
                <tr>
                    <TD>
                        ...
                        <TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="left-table03" id="table3" >
                            <tr>
                                <td height="29">
                                    <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="15%"><img name="img1" id="img4" src="./images/ico04.gif" width="8" height="11" /></td>
                                            <td width="85%">
                                                <a href="javascript:vold(0)" target="mainFrame" class="left-font03" onClick="list('4')" >添加路线</a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <table id="subtree4" style="DISPLAY: none" width="95%" border="0" align="center" cellpadding="0" ellspacing="0" class="left-table02">
                            <tr>
                                <td width="15%" height="20" ><img id="xiaotu6" src="./images/ico06.gif" width="8" height="12" /></td>
                                <td width="85%"><a href="{$URLController}redirst.php?action=recommend" target="mainFrame" class="left-fontSmall" onClick="tupian('6')">添加路线</a></td>
                           <tr>
                        </table>    
                    </TD>
                </tr>
