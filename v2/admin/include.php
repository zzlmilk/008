...
defined('URLController') or define('URLController', 'http://127.0.0.1/008/v2/admin/');
defined('URLAjaxController') or define('URLAjaxController', 'http://127.0.0.1/008/v2/admin/ajax');
defined('URLJsController') or define('URLJsController', 'http://127.0.0.1/008/v2/admin/js');
defined('URLAPI') or define('URLAPI', 'http://127.0.0.1/008');
